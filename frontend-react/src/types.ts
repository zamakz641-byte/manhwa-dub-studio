...
export interface RuntimeStatus {
  ...
  supertonic?: RuntimeModule;
}

export type TtsEngine = 'qwen' | 'omnivoice' | 'supertonic';

export interface Voice {
  id: string;
  name: string;
  engine?: 'Qwen3-TTS' | 'OmniVoice' | 'Supertonic';
  engines?: TtsEngine[];
  gender: string;
  style: string;
  accent?: string;
...
export type SyncStatus = 'ideal' | 'tolerable' | 'retimed' | 'too_long' | 'drift' | 'overlap';
